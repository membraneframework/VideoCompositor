...
exports.intoRegisterOutput = intoRegisterOutput;
exports.intoAudioInputsConfiguration = intoAudioInputsConfiguration;
const input_js_1 = require("./input.js");
function intoRegisterOutput(output, initial) {
...
function intoAudioInputsConfiguration(inputs) {
    return {
        inputs: inputs.map(input => ({
            input_id: (0, input_js_1.inputRefIntoRawId)(input.inputRef),
            volume: input.volume,
        })),
    };
}
